...
function saveTodos() {
  localStorage.setItem("todos", JSON.stringify(allTodos)); //saves the array to local storage
}

function getTodos() {
  const todos = localStorage.getItem("todos") || "[]"; //gets the array from local storage
  if (todos) {
